      ...
      <div className="container mx-auto px-6 md:px-12 flex flex-col items-center text-center">
        ...
        <div className="w-full border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-white/40 gap-4">
          ...
          <p className="text-white/50">
            Fan-built tribute website created with love by <a href="https://ninaadpatnaik.vercel.app" target="_blank" rel="noopener noreferrer" className="text-accent hover:underline">Ninaad Patnaik</a>.
          </p>
        </div>
